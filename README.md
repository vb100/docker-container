...
<p><b>The reason why we create Docker Images is?</b><ul type='square'><li>For <b>sharing</b> and <b>re-distribution</b>.</b>. Many containers can be created from a single Image.</li></ul></p>
